...
const Section = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Tooltips />
            <div className="p-2 grid gap-2 bg-white animasi-popup rounded-md">
                <div className="animasi-popup section flex text-center justify-center">
                    <div className="p-2 font-semibold uppercase text-lg">Daftar Registrasi</div>
                </div>
                                ...
                                <div className="rounded-lg shadow-xl animasi-popup p-0 flex overflow-hidden mb-3">
                                    ...
                                    <div className="w-[70%] p-2 grid gap-1">
                                        ...
                                        <div className="flex justify-end gap-1 mt-3">
                                            {item.kd_pj == 'BPJ' ? item.status == 'Terdaftar' ?
                                                <React.Fragment>
                                                    <div className="section shadow text-xs text-center flex items-center justify-between">
                                                        <div className="">
                                                            Anda Sudah Check In, silakan menuju poli {item.poliklinik.nm_poli}
                                                        </div>
                                                ...
                                                : item.status == 'Batal' ?
                                                    ...
                                                    <>
                                                        <div className="section shadow text-xs">
                                                            <div className="flex justify-between items-center">
                                                                <div className="">
                                                                    Silakan Datang Pada Hari Periksa ke Loket Untuk <span className='font-bold'>
                                                                        Scan Finger
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <React.Fragment>
                                                                <div className="section shadow text-xs text-center flex items-center justify-between">
                                                                    <div className="text-left capitalize">
                                                                        Anda Sudah Check In, silakan menuju {item.poliklinik.nm_poli}
                                                                    </div>
                                                                    <div className="text-primary">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                                                            <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
